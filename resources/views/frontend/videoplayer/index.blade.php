...
<div class="preloader">
   ...
   ======================================-->
    <section class="course-area padding-top-20px padding-bottom-20px">
        <div class="course-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading text-center">
                            <img class="img-fluid header-logo" src="/public/uploads/site/header.png" alt="Course LMS">
                            <br/><br/>
                            <img class="img-fluid" src="/public/asset_rumbok/images/blog-image-1.jpg" alt="Course LMS">
                            <h2 class="section__title"><br/>Video player</h2>
                            <span class="section-divider"></span>
                            <h5>Please click on the "Play" button from the course page on our website.</h5>
